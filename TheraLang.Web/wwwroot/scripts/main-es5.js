...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [
                ...
                { path: "**", loadChildren: function () { return _modules_cms_generic_cms_module__WEBPACK_IMPORTED_MODULE_15__["CmsModule"]; } }
            ];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var resourceUrl = baseUrl + "resources";
            var requestUrl = baseUrl + "request";
            var categoryUrl = baseUrl + "categories";
            var participationUrl = baseUrl + "participants";
            var donationUrl = baseUrl + "donations";
            var projectTypeUrl = baseUrl + "projectTypes";
            var cmsSitemapUrl = baseUrl + "sitemap";
            var statusApproveUrl = projectUrl + "approve";
            var statusRejectUrl = projectUrl + "reject";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var LONG_DATE_STRING = 'y/MM/dd H:mm';
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ForbiddenExts = /(.+)(.cmd|.bat|.exe)$/i;
            /***/ 
        }),
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                function UserService(http, fb, jwtHelper) {
                    this.http = http;
                    this.fb = fb;
            ...
            var SiteMapService = /** @class */ (function () {
                ...
                SiteMapService.prototype.mapToolbarItems = function (siteMap) {
                    ...
                    return siteMap.map(function (item) {
                        ...
                        return new _toolbar_cms_pages_toolbar_item_toolbar_item__WEBPACK_IMPORTED_MODULE_4__["ToolbarItem"](item.permalink, route, item.menuTitle, _this.mapToolbarItems(item.items));
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DonationService = /** @class */ (function () {
                ...
                DonationService.prototype.getProjectCheckoutModel = function (donationAmount, projectId) {
                ...
                DonationService.prototype.getSocietyCheckoutModel = function (donationAmount) {
                    return this.http.get(src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_3__["donationUrl"] + "/" + donationAmount);
                };
                DonationService.prototype.getDonationTransaction = function (donationId) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HttpService = /** @class */ (function () {
                ...
                HttpService.prototype.deleteProject = function (id) {
                    return this.http.delete(this.url + "projects" + "/" + id);
                };
                HttpService.prototype.getAllNewProjects = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/configs/api-endpoint.constants */ "./src/app/configs/api-endpoint.constants.ts");
            var ProjectTypeHttp = /** @class */ (function () {
                function ProjectTypeHttp(http) {
                    this.http = http;
                }
                ProjectTypeHttp.prototype.getAllProjectTypes = function () {
                    return this.http.get(src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_3__["projectTypeUrl"]);
                };
                ProjectTypeHttp.prototype.put = function (data) {
                    var urlParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("id", data.id.toString());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/configs/api-endpoint.constants */ "./src/app/configs/api-endpoint.constants.ts");
            var HttpProjectService = /** @class */ (function () {
                function HttpProjectService(http) {
                    this.http = http;
                    this.url = src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_3__["projectUrl"];
                }
                HttpProjectService.prototype.getAllProjectParticipants = function () {
                    return this.http.get(this.url);
                };
                HttpProjectService.prototype.GetProjectsByStatus = function (status) {
                    return this.http.get(this.url + "/newstatus/" + status);
                };
                HttpProjectService.prototype.Approve = function (id) {
                    return this.http.get(this.url + "/approve/" + id);
                };
                HttpProjectService.prototype.Reject = function (id) {
                    return this.http.get(this.url + "/reject/" + id);
                };
                return HttpProjectService;
            }());
            HttpProjectService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectService = /** @class */ (function () {
                function ProjectService(fb, httpService, notificationService, translate) {
                    this.fb = fb;
                ...
                ProjectService.prototype.addProject = function (project) {
                    var _this = this;
                    this.httpService.createProject(project).subscribe(function (msg) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.translate
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    console.log(error);
                                    _b = (_a = this.notificationService).warn;
                                    return [4 /*yield*/, this.translate.get("common.wth").toPromise()];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                ...
                ProjectService.prototype.editProject = function (project) {
                    var _this = this;
                    this.httpService.updateProject(project).subscribe(function (msg) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.translate.get("updated-successfully").toPromise()];
                                case 1:
                                    msg = _a.sent();
                                    this.notificationService.success(msg);
                                    return [2 /*return*/];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResourceCreateService = /** @class */ (function () {
                function ResourceCreateService(formBuilder, notificationService, http, translate) {
                    var _this = this;
                    ...
                    this.resourceForm.get("file").valueChanges.subscribe(function (val) {
                        var isValidFile = !_this.isNullOrEmpty(val);
                        if (isValidFile) {
                            _this.resourceForm.get("url").disable();
                        }
                        else if (_this.resourceForm.get("url").disabled) {
                            _this.resourceForm.get("url").enable();
                        }
                    });
                }
                ResourceCreateService.prototype.isNullOrEmpty = function (fileInput) {
                    if (fileInput == null) {
                        return true;
                    }
                ...
                ResourceCreateService.prototype.initializeForm = function () {
                ...
                ResourceCreateService.prototype.postResource = function (resource) {
                ...
                ResourceCreateService.prototype.putResource = function (resource) {
                    return this.http.put(this.resourceUrl + "/" + "update", resource);
                };
                ResourceCreateService.prototype.getCategories = function () {
                    return this.http.get(this.categoryUrl + "/" + "get");
                };
                ResourceCreateService.prototype.populateForm = function (resource) {
                    this.resourceForm.setValue(resource);
                };
                ResourceCreateService.prototype.addResource = function (resource) {
                    var _this = this;
                    this.postResource(resource).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).success;
                                    return [4 /*yield*/, this.translate.get("common.created-successfully").toPromise()];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                ...
                ResourceCreateService.prototype.updateResource = function (resource) {
                    var _this = this;
                    this.putResource(resource).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).success;
                                    return [4 /*yield*/, this.translate.get("common.updated-successfully").toPromise()];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
            ...
            ResourceCreateService.ctorParameters = function () { return [
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
            ...
            var CmsRouteHelperService = /** @class */ (function () {
                ...
                CmsRouteHelperService.prototype.createSiteSlugMap = function (toolbarItems) {
                    ...
                    toolbarItems.forEach(function (item) {
                        _this.createSiteSlugMap(item.subItems).forEach(function (value, key) { return map.set(key, value); });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectTypeService = /** @class */ (function () {
                function ProjectTypeService(http, notificationService, translate) {
                    this.http = http;
                    this.notificationService = notificationService;
                    this.translate = translate;
                }
                ...
                ProjectTypeService.prototype.Update = function (projectType) {
                    var _this = this;
                    this.http.put(projectType).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).success;
                                    return [4 /*yield*/, this.getLocalization("common.updated-successfully")];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).warn;
                                    return [4 /*yield*/, this.getLocalization("common.wth")];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                ...
                ProjectTypeService.prototype.Create = function (newProjectType) {
                    var _this = this;
                    this.http.post(newProjectType).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).success;
                                    return [4 /*yield*/, this.getLocalization("common.added-successfully")];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                ...
                ProjectTypeService.prototype.Delete = function (projectTypeId) {
                    var _this = this;
                    this.http.delete(projectTypeId).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.notificationService).success;
                                    return [4 /*yield*/, this.getLocalization("common.deleted-successfully")];
                                case 1:
                                    _b.apply(_a, [_c.sent()]);
                                    return [2 /*return*/];
                            }
                ...
                ProjectTypeService.prototype.getLocalization = function (locPath) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _http_cms_site_map_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../http/cms/site-map.service */ "./src/app/core/http/cms/site-map.service.ts");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var CmsPagesToolbarItemComponent = /** @class */ (function () {
                function CmsPagesToolbarItemComponent(siteMapService) {
                    this.siteMapService = siteMapService;
                    this.toolbarItems = [];
                    this.subscription = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subscription"]();
                }
                CmsPagesToolbarItemComponent.prototype.ngOnInit = function () {
                    this.subscribeOnSiteMapService();
                };
                CmsPagesToolbarItemComponent.prototype.ngOnDestroy = function () {
                    this.subscription.unsubscribe();
                };
                CmsPagesToolbarItemComponent.prototype.subscribeOnSiteMapService = function () {
                    var _this = this;
                ...
                return CmsPagesToolbarItemComponent;
            }());
            CmsPagesToolbarItemComponent.ctorParameters = function () { return [
                { type: _http_cms_site_map_service__WEBPACK_IMPORTED_MODULE_2__["SiteMapService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LanguageComponent = /** @class */ (function () {
                ...
                LanguageComponent.prototype.changeLang = function (lang) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProfileMenuComponent = /** @class */ (function () {
                function ProfileMenuComponent(userService, notification, translate, router) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToolbarComponent = /** @class */ (function () {
                function ToolbarComponent(participantService, eventService, dialog, userService) {
                ...
                ToolbarComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var subscription = this.participantService
                        .getAllProjectParticipants()
                        .subscribe(function (projectParticipation) {
                        _this.projectParticipation = projectParticipation;
                        if (_this.projectParticipation.filter(function (x) { return x.status === src_app_configs_project_participation_request_status__WEBPACK_IMPORTED_MODULE_7__["ProjectParticipationRequestStatus"].New; }).length > 0) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var routes = [{ path: "**", component: _components_cms_generic_page_cms_generic_page_component__WEBPACK_IMPORTED_MODULE_3__["CmsGenericPageComponent"] }];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(notificationService, dialog, userService, translate, router) {
                    this.notificationService = notificationService;
                    this.dialog = dialog;
                    this.userService = userService;
                    this.translate = translate;
                ...
                LoginComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.userService.login(this.userService.loginForm.value).subscribe(function (response) {
                ...
                DonationComponent.prototype.checkout = function () {
                    ...
                    if (this.projectId !== 0) {
                        this.donationService
                            ...
                            .subscribe(function (checkoutModel) {
                            _this.donationModel = checkoutModel;
                            window.location.replace(src_app_configs_api_endpoint_constants__WEBPACK_IMPORTED_MODULE_4__["liqpayCheckoutUrl"] + "?data=" + _this.donationModel.data + "&signature=" + _this.donationModel.signature);
                        });
                    }
                    else {
                        this.donationService
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var DaysLeftPipe = /** @class */ (function () {
                function DaysLeftPipe() {
                }
                DaysLeftPipe.prototype.transform = function (project) {
                    var endDate = new Date(project.projectEnd);
                    var timeLeft = endDate.getTime() - Date.now();
                    if (timeLeft <= 0)
                        return "Expired";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectFormComponent = /** @class */ (function () {
                function ProjectFormComponent(dialog, service, dateAdapter, translate) {
                    this.dialog = dialog;
                ...
                ProjectFormComponent.prototype.ngOnInit = function () {
                    ...
                    this.dateAdapter.setLocale(this.translate.currentLang),
                        (this.dateAdapter.getFirstDayOfWeek = function () {
                            return 1;
                        }),
                        this.service
                            .getProjectTypes()
                            .subscribe(function (projectTypes) { return (_this.projectTypes = projectTypes); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectInfoComponent = /** @class */ (function () {
                function ProjectInfoComponent(route, http, resourceService, participService, notificationService, translate) {
                    this.route = route;
                    this.http = http;
                ...
                ProjectInfoComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.paramMap.subscribe(function (params) {
                        ...
                        _this.http
                            .getProjectInfo(_this.projectId)
                            .subscribe(function (data) { return (_this.projectInfo = data); });
                    });
                };
                ...
                ProjectInfoComponent.prototype.onJoin = function () {
                    var _this = this;
                    this.participService.createParticipRequest(this.projectId).subscribe(function (msg) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.translate
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectTypeComponent = /** @class */ (function () {
                function ProjectTypeComponent(projectTypeService, dialogService, http, dialog) {
                ...
                ProjectTypeComponent.prototype.onCreate = function () {
                    var _this = this;
                ...
                ProjectTypeComponent.prototype.onEdit = function (projectType) {
                    var _this = this;
                    var dialogRef = this.dialog
                ...
                ProjectTypeComponent.prototype.onDelete = function (id) {
                    var _this = this;
                    this.http.delete(id).subscribe(function (res) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
            ...
            var ProjectParticipantsComponent = /** @class */ (function () {
                ...
                ProjectParticipantsComponent.prototype.ngOnInit = function () {
                    ...
                    this.participantService
                        .getAllProjectParticipants()
                        .subscribe(function (projectParticipants) {
                        ...
                        _this.projectParticipationRequest.filter = src_app_configs_project_participation_request_status__WEBPACK_IMPORTED_MODULE_5__["ProjectParticipationRequestStatus"].New.toString();
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectRequestComponent = /** @class */ (function () {
                function ProjectRequestComponent(http, projectRequestService) {
                    this.http = http;
                    this.projectRequestService = projectRequestService;
                    this.showActionButtons = true;
                }
                ProjectRequestComponent.prototype.changeStatus = function (status, project) {
                    var _this = this;
                    status === "approved"
                        ? this.projectRequestService
                            .Approve(project.id)
                            .subscribe(function (data) { return _this.loadNewProjects(); })
                        : this.projectRequestService
                            .Reject(project.id)
                            .subscribe(function (data) { return _this.loadNewProjects(); });
                };
                ...
                ProjectRequestComponent.prototype.loadNewProjects = function () {
                    var _this = this;
                    this.http.getAllNewProjects().subscribe(function (projects) {
                        _this.projects = projects;
                    });
                };
                ProjectRequestComponent.prototype.changeTab = function (tabPosition) {
                    var _this = this;
                    if (tabPosition === 1) {
            ...
            ProjectRequestComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
            var ProjectTypeCreateFormComponent = /** @class */ (function () {
                function ProjectTypeCreateFormComponent(dialog, service, dateAdapter) {
                    this.dialog = dialog;
                    this.service = service;
                    this.dateAdapter = dateAdapter;
                }
                ProjectTypeCreateFormComponent.prototype.ngOnInit = function () {
                    this.newData = new _shared_models_project_type_project_type_model__WEBPACK_IMPORTED_MODULE_3__["ProjectType"]();
                };
                ProjectTypeCreateFormComponent.prototype.onCloseForm = function () {
                    this.dialog.close();
                };
                ProjectTypeCreateFormComponent.prototype.onSubmit = function () {
                    this.service.Create(this.newData);
                };
                return ProjectTypeCreateFormComponent;
            }());
            ProjectTypeCreateFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectTypeFormComponent = /** @class */ (function () {
                function ProjectTypeFormComponent(dialog, service, dateAdapter, data) {
                    this.dialog = dialog;
                    this.service = service;
                    this.dateAdapter = dateAdapter;
                    this.data = data;
                }
                ProjectTypeFormComponent.prototype.ngOnInit = function () { };
                ProjectTypeFormComponent.prototype.onCloseForm = function () {
                    this.dialog.close();
                };
                ProjectTypeFormComponent.prototype.onSubmit = function () {
                    var newData = new _shared_models_project_type_project_type_model__WEBPACK_IMPORTED_MODULE_4__["ProjectType"]();
                    newData.id = this.data.id;
                    newData.typeName = this.data.name;
                    this.service.Update(newData);
                };
                return ProjectTypeFormComponent;
            }());
            ProjectTypeFormComponent.ctorParameters = function () { return [
                { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectComponent = /** @class */ (function () {
                function ProjectComponent(httpService, dialogService, service, notificationService, translate) {
                    this.httpService = httpService;
                    this.dialogService = dialogService;
                    this.service = service;
                    this.notificationService = notificationService;
                ...
                ProjectComponent.prototype.onDelete = function (id) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var _a, _b;
                        var _this = this;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _b = (_a = this.dialogService).openConfirmDialog;
                                    return [4 /*yield*/, this.translate.get("common.r-u-sure").toPromise()];
                                case 1:
                                    _b.apply(_a, [_c.sent()])
                                        .afterClosed()
                                        ...
                                        return __generator(this, function (_c) {
                                            switch (_c.label) {
                                                case 0:
                                                    ...
                                                    this.httpService.deleteProject(id).subscribe(function (result) {
                                                        _this.httpService
                                                            .getAllProjects()
                                                            .subscribe(function (projects) { return (_this.projects = projects); });
                                                    });
                                                    _b = (_a = this.notificationService).warn;
                                                    return [4 /*yield*/, this.translate.get("common.deleted-successfully").toPromise()];
                                                case 1:
                                                    _b.apply(_a, [_c.sent()]);
                                                    _c.label = 2;
                ...
                ProjectComponent.prototype.getProjectProgress = function (project) {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, this.resourceService.getResourcesByCategoryId(this.resourcesCategoryId, _configs_resources_table__WEBPACK_IMPORTED_MODULE_3__["ResourcesTableConstants"].PAGE_NUMBER, _configs_resources_table__WEBPACK_IMPORTED_MODULE_3__["ResourcesTableConstants"].COLUMNS_PER_PAGE)];
                                case 1:
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GeneralResourcesTableComponent = /** @class */ (function () {
                function GeneralResourcesTableComponent(resourceService, resourceCategoriesService, resourceCreateService, dialogService) {
                    this.resourceService = resourceService;
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    _a = this;
                                    return [4 /*yield*/, this.resourceCategoriesService.getResourceCategories(_configs_resources_table__WEBPACK_IMPORTED_MODULE_2__["ResourcesTableConstants"].WITH_ASSIGNED_RESOURCES)];
                                case 1:
                ...
                GeneralResourcesTableComponent.prototype.addResource = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ResourceCreateComponent = /** @class */ (function () {
                function ResourceCreateComponent(dialog, service) {
                    this.dialog = dialog;
                    this.service = service;
                }
                ...
                ResourceCreateComponent.prototype.onClose = function () {
                    this.service.resourceForm.reset();
                    this.service.initializeForm();
                    this.dialog.close();
                };
                ResourceCreateComponent.prototype.onFileChange = function (fileInput) {
                    var file = fileInput.target.files[0];
                    this.fileName = file.name;
                };
                ResourceCreateComponent.prototype.onSubmit = function () {
                    if (this.service.resourceForm.invalid) {
                        var controls_2 = this.service.resourceForm.controls;
                        Object.keys(controls_2).forEach(function (controlName) { return controls_2[controlName].markAsTouched(); });
                        return;
                    }
                    else {
                        var resource = this.service.resourceForm.value;
            ...
            ResourceCreateComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreatePageComponent = /** @class */ (function () {
                function CreatePageComponent(pageService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var PageManagerComponent = /** @class */ (function () {
                function PageManagerComponent(router) {
                    this.router = router;
                }
                PageManagerComponent.prototype.ngOnInit = function () {
                };
                return PageManagerComponent;
            }());
            PageManagerComponent.ctorParameters = function () { return [
            ...
            var TransactionResultComponent = /** @class */ (function () {
                ...
                TransactionResultComponent.prototype.ngOnInit = function () {
                    ...
                    this.route.paramMap.subscribe(function (params) {
                        ...
                        _this.donationService
                            .getDonationTransaction(_this.donationId)
                            .subscribe(function (liqpayResponseData) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var atLeastOne = function (validator, controls) {
                if (controls === void 0) { controls = null; }
                return function (group) {
                    if (!controls) {
                        controls = Object.keys(group.controls);
                    }
                    var hasAtLeastOne = group &&
                        group.controls &&
                        controls.some(function (k) { return !validator(group.controls[k]); });
            ...
            function forbiddenExtensionValidator(exts) {
                return function (control) {
                    try {
                        ...
                        var filename = control.value.files[0].name;
                        var forbidden = exts.test(filename);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CustomDatePipe = /** @class */ (function (_super) {
                ...
                CustomDatePipe.prototype.transform = function (value, args) {
                    return _super.prototype.transform.call(this, value, src_app_configs_date_formats__WEBPACK_IMPORTED_MODULE_3__["LONG_DATE_STRING"]);
                };
