...
namespace WebAPI.Controllers
{
    ...
    public class ResourceController : Controller
    {
        ...
        {
            Resource resource1 = new Resource { Id = 1, Name = "Good boy", Date = new DateTime(2015, 7, 20), Description = "https://www.brovarnya-rivne.com/img/images/poroda-hatiko-akita-inu-opisanie-i-harakter-uhod-za-yaponskoj-porodoj-iz-filma-hatiko.jpg", ProjectId = 1 };
            Resource resource4 = new Resource { Id = 4, Name = "Hatiko so sweety", Date = new DateTime(2015, 7, 20), Description = "https://piensosloboazul.com/wp-content/uploads/2019/01/Hachiko-richard-gere.jpg", ProjectId = 1 };
